...
小红书平台对于涉嫌推广其他平台的内容的检测比较严格，这是其部分规则：

1.存在展示其他平台界面信息的行为(店面截图、订单截
图等)；

2.存在尝试引导他人前往其他平台进行搜索、浏览或查看
的行为；

3.存在通过种草、科普、教程、测评等方式为其他平台进
行宣传介绍的行为；

4.存在通过福利红包、专属优惠等方式吸引他人跳转至其
他平台的行为；

5.存在对其他平台的产品、服务、价格、会员权益及付费内容进
行推荐或介绍的行为；

文案要尽量规避可能的风险，避免太明显的推广行为。
